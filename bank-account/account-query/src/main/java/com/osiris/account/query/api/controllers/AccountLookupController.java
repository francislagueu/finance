package com.osiris.account.query.api.controllers;

import com.osiris.account.query.api.dto.AccountLookupResponse;
import com.osiris.account.query.api.dto.EqualityType;
import com.osiris.account.query.api.queries.FindAccountByHolderQuery;
import com.osiris.account.query.api.queries.FindAccountByIdQuery;
import com.osiris.account.query.api.queries.FindAccountWithBalanceQuery;
import com.osiris.account.query.api.queries.FindAllAccountsQuery;
import com.osiris.account.query.domain.BankAccount;
import com.osiris.messaging.infrastructure.QueryDispatcher;
...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAccountWithBalance(@PathVariable(value = "equalityType") EqualityType equalityType, @PathVariable(value = "balance") double balance){
        try{
            ...
            var message = "Failed to complete get account with balance request!!!";
            logger.log(Level.SEVERE, message, e);
            return new ResponseEntity<>(new AccountLookupResponse(message), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
